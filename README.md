# Digital Window (WIP)
Project to create a CAVE/AR type of display based on head tracking data + off-axis projection. Currently, only head tracking is present, currently working on fine-tuning the head tracking and working in Unity/Godot for rendering.  
# Requirements
